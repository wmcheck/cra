      ...
      <div className="container">
        ...
        <section className="sidebar">
          ...
          <div className="contacts">
            <h2>О себе</h2>
            <div className="compact">
              <p>Не конфликтный, готов брать ответственность</p>
        ...
        <div className="content content_experience">
          ...
          <section>
            ...
            <p>
              ...
              розничных и бюджетных цен на лекарственные препараты", построение
              графических представлений для аналитики в различных срезах,
              формирование отчетов, справок и импорт данных от организаций
              поставщиков и аптечных сетей.
            </p>
          </section>
          <section>
            <h3>РОСТЕХНАДЗОР</h3>
